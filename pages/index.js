    ...
    <>
      ...
      <main>
        ...
        <div className='custom-background-blue'>
          <div id='service' className={`container-heading-service fade-in ${visibleTexts[5] ? 'loaded' : ''}`} ref={el => textRefs.current[5] = el}>
            ...
            <div className=' custom-text-color-service row custom-height-service container-fluid  '>
              ...
              <div className='col-md-6 d-flex flex-column '>
                ...
                <div className={`custom-margin-service col fade-in ${visibleTexts[6] ? 'loaded' : ''}`} ref={el => textRefs.current[6] = el}>
                  <div className='custom-margin-service col fs-5'>
                    <h2 className='custom-text-color-service display-6 fw-bold  text-left'>
                    ...
                    <div className='d-flex justify-content-center'>
                      <button type="button" style={{ width: '200px', backgroundColor: 'lightgray' }} className="bg-transparent text-white see-more-btn-light p-2">
                        Kontakt aufnehmen
                      </button>
                    </div>
                  </div>
              ...
              <div className={`col-md-6 d-flex flex-column  fade-in ${visibleTexts[8] ? 'loaded' : ''}`} ref={el => textRefs.current[8] = el}>
                ...
                <div className='custom-margin-service col fs-5'>
                  ...
                  <div className='d-flex justify-content-center'>
                    <button type="button" disabled style={{ width: '200px', backgroundColor: 'lightgray' }} className="bg-transparent text-white p-2 see-more-btn-light">
                      Kontakt aufnehmen <span className="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Loading...
                    </button>
                  </div>
                </div>
        ...
        <div className='vh-100 mb-5'>
              ...
              <div className=''>
                <div /* width={1000} */ className='h-25 custom-text-container '>
                  ...
                  <div className='d-flex justify-content-left'>
                    <button type="button" style={{ width: '200px', backgroundColor: 'lightgray' }} className="bg-transparent see-more-btn-light p-2 text-white">Projekt anfragen</button>
                  </div>
                </div>
              </div>
            </section>
          ...
          <div className='container custom-height-container d-flex justify-content-center align-items-center'>
            <div /* width={1000} */ className={`text-center h-25 fade-in ${visibleTexts[2] ? 'loaded' : ''}`} ref={el => textRefs.current[2] = el}>
              ...
              <div className='d-flex justify-content-center'>
                <button type="button" style={{ width: '200px', backgroundColor: 'lightgray' }} className="bg-transparent see-more-btn-dark p-2">Projekt anfragen</button>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className='  pie-chart-container-height  d-flex align-items-center'>
          <div className="container mt-5 d-flex align-items-center justify-content-evenly">
            <div className='pie-chart-text'>
              <p className=' display-6 pie-chart-heading-left mb-4'>Part-Designer</p>
              <p> <span  className='pie-char-span'>✔</span>BOOTSTRAP</p>
              <p><span  className='pie-char-span'>✔</span>SASS</p>
              <p><span  className='pie-char-span'>✔</span>ADOBE XD / FIGMA </p>
              <p><span  className='pie-char-span'>✔</span>RESPONSIVE WEBDESIGN</p>
              <p><span  className='pie-char-span'>✔</span>HTML / CSS</p>
            </div>
            <PieChart />
            <div className='pie-chart-text'>
              <p className=" display-6 pie-chart-heading-right mb-4">Part-Coder</p>
              <p><span  className='pie-char-span'>✔</span>FRONTEND ENTWICKLUNG</p>
              <p><span  className='pie-char-span'>✔</span>JAVASCRIPT</p>
              <p><span  className='pie-char-span'>✔</span>REACT / NEXT</p>
              <p><span  className='pie-char-span'>✔</span>MEINEN COMPUTER ANSCHREIEN</p>
              <p><span  className='pie-char-span'>✔</span>PIZZA ESSEN</p>
            </div>
          </div>
        </section>
          ...
          <div className='custom-height-container-umsetzung d-flex justify-content-center align-items-center'>
            <div /* width={1000} */ className={`text-center h-25 fade-in ${visibleTexts[3] ? 'loaded' : ''}`} ref={el => textRefs.current[3] = el}>
              ...
              <div className='d-flex justify-content-center'>
                <button type="button" style={{ width: '200px', backgroundColor: 'lightgray' }} className="bg-transparent see-more-btn-dark p-2">jetzt Kontakt aufnehmen</button>
              </div>
            </div>
          </div>
        </section>
